...
namespace sumadera1._2
{
    public partial class Form1 : Form
    {
        ...
        {
            txt_resultado1.Text = Convert.ToString(int.Parse(txt_num1.Text) + int.Parse(txt_num2.Text) + int.Parse(txt_num3.Text) + int.Parse(txt_num4.Text) + int.Parse(txt_num5.Text));
            txt_resultado5.Text = Convert.ToString(int.Parse(txt_num2.Text) + int.Parse(txt_num7.Text) + int.Parse(txt_num12.Text));
        }

        private void txt_num3_TextChanged(object sender, EventArgs e)
        {
            txt_resultado1.Text = Convert.ToString(int.Parse(txt_num1.Text) + int.Parse(txt_num2.Text) + int.Parse(txt_num3.Text) + int.Parse(txt_num4.Text) + int.Parse(txt_num5.Text));
            txt_resultado6.Text = Convert.ToString(int.Parse(txt_num3.Text) + int.Parse(txt_num8.Text) + int.Parse(txt_num13.Text));
        }
        ...
        {
            txt_resultado1.Text = Convert.ToString(int.Parse(txt_num1.Text) + int.Parse(txt_num2.Text) + int.Parse(txt_num3.Text) + int.Parse(txt_num4.Text) + int.Parse(txt_num5.Text));
            txt_resultado8.Text = Convert.ToString(int.Parse(txt_num5.Text) + int.Parse(txt_num10.Text) + int.Parse(txt_num15.Text));
        ...
        {
            txt_resultado2.Text = Convert.ToString(int.Parse(txt_num6.Text) + int.Parse(txt_num7.Text) + int.Parse(txt_num8.Text) + int.Parse(txt_num9.Text) + int.Parse(txt_num10.Text));
            txt_resultado7.Text = Convert.ToString(int.Parse(txt_num4.Text) + int.Parse(txt_num9.Text) + int.Parse(txt_num14.Text));
        }
